...
template <typename T, typename X> NumericType<T, X> &NumericType<T, X>::operator=(raw_type const t)
{
  _t = t;
  return *this;
}
template <typename T, typename X> NumericType<T, X> &NumericType<T, X>::operator=(self const &that)
{
  _t = that._t;
  return *this;
}
...
template <typename T, typename X> NumericType<T, X> &NumericType<T, X>::operator+=(raw_type t)
{
  _t += t;
  return *this;
}
...
template <typename T, typename X> NumericType<T, X> operator+(T const &lhs, NumericType<T, X> const &rhs)
{
  return rhs + lhs;
}
template <typename T, typename X> NumericType<T, X> operator-(T const &lhs, NumericType<T, X> const &rhs)
