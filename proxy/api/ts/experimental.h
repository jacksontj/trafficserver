...
typedef enum { NODE_ONLINE = 1, NODE_OFFLINE } TSNodeStatus_t;
...
typedef enum { TS_PREFETCH_UDP_BLAST = 0, TS_PREFETCH_TCP_BLAST, TS_PREFETCH_MULTICAST_BLAST } TSPrefetchBlastType;
...
typedef enum { TS_PREFETCH_CONTINUE, TS_PREFETCH_DISCONTINUE } TSPrefetchReturnCode;
