...
public:
  ...
  enum LookingUp_t { ORIGIN_SERVER, UNDEFINED_LOOKUP, ICP_SUGGESTED_HOST, PARENT_PROXY, INCOMING_ROUTER, HOST_NONE };
  ...
  enum LockUrl_t { LOCK_URL_FIRST = 0, LOCK_URL_SECOND, LOCK_URL_ORIGINAL, LOCK_URL_DONE, LOCK_URL_QUIT };

  enum RangeSetup_t { RANGE_NONE = 0, RANGE_REQUESTED, RANGE_NOT_SATISFIABLE, RANGE_NOT_HANDLED, RANGE_NOT_TRANSFORM_REQUESTED };
