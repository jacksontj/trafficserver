...
typedef enum { ORIG_TS_PARSE_ERROR = -1, ORIG_TS_PARSE_DONE = 0, ORIG_TS_PARSE_OK = 1, ORIG_TS_PARSE_CONT = 2 } ORIG_TSParseResult;

typedef enum { ORIG_TS_HTTP_TYPE_UNKNOWN, ORIG_TS_HTTP_TYPE_REQUEST, ORIG_TS_HTTP_TYPE_RESPONSE } ORIG_TSHttpType;
...
typedef enum { ORIG_TS_CACHE_LOOKUP_MISS, ORIG_TS_CACHE_LOOKUP_HIT_STALE, ORIG_TS_CACHE_LOOKUP_HIT_FRESH } ORIG_TSCacheLookupResult;

typedef enum { ORIG_TS_CACHE_DATA_TYPE_NONE, ORIG_TS_CACHE_DATA_TYPE_HTTP, ORIG_TS_CACHE_DATA_TYPE_OTHER } ORIG_TSCacheDataType;
...
typedef enum { ORIG_TS_VC_CLOSE_ABORT = -1, ORIG_TS_VC_CLOSE_NORMAL = 1 } ORIG_TSVConnCloseFlags;

typedef enum { ORIG_TS_SDK_VERSION_2_0 = 0, ORIG_TS_SDK_VERSION_3_0 } ORIG_TSSDKVersion;

typedef enum { ORIG_TS_ERROR = -1, ORIG_TS_SUCCESS = 0 } ORIG_TSReturnCode;
