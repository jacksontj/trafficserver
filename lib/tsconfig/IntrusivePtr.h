...
inline IntrusivePtrCounter &IntrusivePtrCounter::operator=(IntrusivePtrCounter const &)
{
  return *this;
}
...
template <typename T> bool IntrusivePtrPolicy<T>::Order::operator()(IntrusivePtr<T> const &lhs, IntrusivePtr<T> const &rhs) const
{
...
template <typename T> IntrusivePtr<T> &IntrusivePtr<T>::operator=(const self &that)
{
...
template <typename T>
template <typename X>
IntrusivePtr<T> &IntrusivePtr<T>::operator=(IntrusivePtr<X> const &that ///< Foreign pointer.
                                            )
{
  this->reset(that.get());
  return *this;
...
template <typename T> IntrusivePtr<T> &IntrusivePtr<T>::operator=(T *obj)
{
  this->reset(obj);
  return *this;
}
...
/* Pointer comparison */
template <typename T> bool operator==(IntrusivePtr<T> const &lhs, IntrusivePtr<T> const &rhs)
{
  return lhs.get() == rhs.get();
}
...
template <typename T> bool operator==(IntrusivePtr<T> const &lhs, int rhs)
{
  assert(0 == rhs);
  return lhs.get() == 0;
}

template <typename T> bool operator==(int lhs, IntrusivePtr<T> const &rhs)
{
  assert(0 == lhs);
  return rhs.get() == 0;
}
