...
enum PluginVC_t { PLUGIN_VC_UNKNOWN, PLUGIN_VC_ACTIVE, PLUGIN_VC_PASSIVE };

// For the id in set_data/get_data
enum { PLUGIN_VC_DATA_LOCAL, PLUGIN_VC_DATA_REMOTE };

enum { PLUGIN_VC_MAGIC_ALIVE = 0xaabbccdd, PLUGIN_VC_MAGIC_DEAD = 0xaabbdead };
