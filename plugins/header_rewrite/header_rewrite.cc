...
const char *HOOK_NAMES[] = {"TS_HTTP_READ_REQUEST_HDR_HOOK", "TS_HTTP_OS_DNS_HOOK", "TS_HTTP_SEND_REQUEST_HDR_HOOK",
                            ...
                            "TS_HTTP_TXN_START_HOOK", "TS_HTTP_TXN_CLOSE_HOOK", "TS_HTTP_SSN_START_HOOK", "TS_HTTP_SSN_CLOSE_HOOK",
                            "TS_HTTP_CACHE_LOOKUP_COMPLETE_HOOK", "TS_HTTP_PRE_REMAP_HOOK", "TS_HTTP_POST_REMAP_HOOK",
