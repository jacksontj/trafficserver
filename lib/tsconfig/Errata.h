...
template <typename R> struct Rv : public RvBase {
  ...
  */
  Result &operator=(Result const &r ///< Result to assign
                    )
  {
    _result = r;
    return _result;
...
inline Errata::iterator &Errata::iterator::operator=(self const &that)
{
  this->super::operator=(that);
  return *this;
}
inline Errata::iterator &Errata::iterator::operator=(super const &that)
{
  this->super::operator=(that);
  return *this;
}
...
inline Errata::const_iterator &Errata::const_iterator::operator=(self const &that)
{
  super::operator=(that);
  return *this;
}
inline Errata::const_iterator &Errata::const_iterator::operator=(super const &that)
{
  super::operator=(that);
  return *this;
}
...
template <typename T> Rv<T> &Rv<T>::operator=(Errata const &errata)
{
  _errata = errata;
  return *this;
}
