...
http_server_session_sharing_cb(char const *name, RecDataT dtype, RecData data, void *cookie)
{
  ...
  if (0 == strcasecmp("proxy.config.http.server_session_sharing.pool", name)) {
    ...
    } else if (RECD_STRING == dtype && http_config_enum_search(data.rec_string, SessionSharingMatchStrings,
    ...
    if (RECD_INT == dtype) {
      match = static_cast<TSServerSessionSharingPoolType>(data.rec_int);
               ...
               http_config_enum_search(data.rec_string, SessionSharingPoolStrings, ARRAY_SIZE(SessionSharingPoolStrings), match)) {
      // empty
    } else {
      valid_p = false;
    }
...
register_stat_callbacks()
{
  ...
  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.current_parent_proxy_transactions", RECD_INT, RECP_NON_PERSISTENT,
  ...
  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.current_icp_transactions", RECD_INT, RECP_NON_PERSISTENT,
                     (int)http_current_icp_transactions_stat, RecRawStatSyncSum);
  ...
  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.current_parent_proxy_raw_transactions", RECD_INT,
                     RECP_NON_PERSISTENT, (int)http_current_parent_proxy_raw_transactions_stat, RecRawStatSyncSum);
  HTTP_CLEAR_DYN_STAT(http_current_parent_proxy_raw_transactions_stat);
  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.current_icp_raw_transactions", RECD_INT, RECP_NON_PERSISTENT,
                     (int)http_current_icp_raw_transactions_stat, RecRawStatSyncSum);
  HTTP_CLEAR_DYN_STAT(http_current_icp_raw_transactions_stat);
  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.current_server_raw_transactions", RECD_INT, RECP_NON_PERSISTENT,
                     (int)http_current_server_raw_transactions_stat, RecRawStatSyncSum);
  ...
  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.avg_transactions_per_parent_connection", RECD_FLOAT,
                     RECP_PERSISTENT, (int)http_transactions_per_parent_con, RecRawStatSyncAvg);

  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.client_connection_time", RECD_INT, RECP_PERSISTENT,
                     (int)http_client_connection_time_stat, RecRawStatSyncSum);

  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.parent_proxy_connection_time", RECD_INT, RECP_PERSISTENT,
                     (int)http_parent_proxy_connection_time_stat, RecRawStatSyncSum);

  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.server_connection_time", RECD_INT, RECP_PERSISTENT,
                     (int)http_server_connection_time_stat, RecRawStatSyncSum);

  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.cache_connection_time", RECD_INT, RECP_PERSISTENT,
                     (int)http_cache_connection_time_stat, RecRawStatSyncSum);
  ...
  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.transaction_counts.errors.empty_hangups", RECD_COUNTER,
                     RECP_PERSISTENT, (int)http_ua_msecs_counts_errors_empty_hangups_stat, RecRawStatSyncCount);

  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.transaction_totaltime.errors.empty_hangups", RECD_FLOAT,
                     RECP_PERSISTENT, (int)http_ua_msecs_counts_errors_empty_hangups_stat, RecRawStatSyncCount);

  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.transaction_counts.errors.early_hangups", RECD_COUNTER,
                     RECP_PERSISTENT, (int)http_ua_msecs_counts_errors_early_hangups_stat, RecRawStatSyncCount);

  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.transaction_totaltime.errors.early_hangups", RECD_FLOAT,
                     RECP_PERSISTENT, (int)http_ua_msecs_counts_errors_early_hangups_stat, RecRawStatSyncCount);
  ...
  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.client_no_cache_requests", RECD_COUNTER, RECP_PERSISTENT,
  ...
  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.client_transaction_time", RECD_INT, RECP_PERSISTENT,
                     (int)http_client_transaction_time_stat, RecRawStatSyncSum);

  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.client_write_time", RECD_INT, RECP_PERSISTENT,
                     (int)http_client_write_time_stat, RecRawStatSyncSum);

  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.server_read_time", RECD_INT, RECP_PERSISTENT,
                     (int)http_server_read_time_stat, RecRawStatSyncSum);

  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.icp_transaction_time", RECD_INT, RECP_PERSISTENT,
                     (int)http_icp_transaction_time_stat, RecRawStatSyncSum);

  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.icp_raw_transaction_time", RECD_INT, RECP_PERSISTENT,
                     (int)http_icp_raw_transaction_time_stat, RecRawStatSyncSum);
  ...
  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.parent_proxy_raw_transaction_time", RECD_INT, RECP_PERSISTENT,
                     (int)http_parent_proxy_raw_transaction_time_stat, RecRawStatSyncSum);

  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.server_transaction_time", RECD_INT, RECP_PERSISTENT,
                     (int)http_server_transaction_time_stat, RecRawStatSyncSum);

  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.server_raw_transaction_time", RECD_INT, RECP_PERSISTENT,
                     (int)http_server_raw_transaction_time_stat, RecRawStatSyncSum);
  ...
  RecRegisterRawStat(http_rsb, RECT_PROCESS, "proxy.process.http.total_transactions_think_time", RECD_INT, RECP_PERSISTENT,
                     (int)http_total_transactions_think_time_stat, RecRawStatSyncSum);
...
HttpConfig::startup()
{
  ...
  http_config_enum_read("proxy.config.http.server_session_sharing.pool", SessionSharingPoolStrings,
                        ARRAY_SIZE(SessionSharingPoolStrings), c.oride.server_session_sharing_pool);
  ...
  http_config_enum_read("proxy.config.http.server_session_sharing.match", SessionSharingMatchStrings,
                        ARRAY_SIZE(SessionSharingMatchStrings), c.oride.server_session_sharing_match);
