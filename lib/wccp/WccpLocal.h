...
enum CacheAssignmentType { ASSIGNMENT_BY_HASH = 0, ASSIGNMENT_BY_MASK = 1 };

/// Top level message types.
enum message_type_t { INVALID_MSG_TYPE = 0, HERE_I_AM = 10, I_SEE_YOU = 11, REDIRECT_ASSIGN = 12, REMOVAL_QUERY = 13 };
