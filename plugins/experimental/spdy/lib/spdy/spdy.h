...
namespace spdy
{
enum protocol_version : unsigned { PROTOCOL_VERSION_2 = 2, PROTOCOL_VERSION_3 = 3 };

enum : unsigned { PROTOCOL_VERSION = 3, MAX_FRAME_LENGTH = (1u << 24) };

enum : unsigned { FLAG_FIN = 1, FLAG_COMPRESSED = 2 };
