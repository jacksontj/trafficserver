...
typedef enum { TS_PROXY_ON, TS_PROXY_OFF, TS_PROXY_UNDEFINED } TSProxyStateT;
...
typedef enum { TS_REC_INT, TS_REC_COUNTER, TS_REC_FLOAT, TS_REC_STRING, TS_REC_UNDEFINED } TSRecordT;
...
{ TS_SIZE_FMT_PERCENT,  /* as a percentage */
  ...
  TS_SIZE_FMT_UNDEFINED } TSSizeFormatT;

typedef enum { TS_HTTP_CONGEST_PER_IP, TS_HTTP_CONGEST_PER_HOST, TS_HTTP_CONGEST_UNDEFINED } TSCongestionSchemeT;

typedef enum { TS_PROTOCOL_DNS, TS_PROTOCOL_UNDEFINED } TSProtocolT;
