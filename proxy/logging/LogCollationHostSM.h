...
private:
  enum HostState { LOG_COLL_HOST_NULL, LOG_COLL_HOST_AUTH, LOG_COLL_HOST_DONE, LOG_COLL_HOST_INIT, LOG_COLL_HOST_RECV };

  enum ReadState { LOG_COLL_READ_NULL, LOG_COLL_READ_BODY, LOG_COLL_READ_HDR };
