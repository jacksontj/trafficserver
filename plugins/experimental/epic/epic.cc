...
#define GAUGE_METRIC_NAMES                                                                                                         \
  "proxy.node.bandwidth_hit_ratio_avg_10s", "proxy.node.bandwidth_hit_ratio_avg_10s_int_pct",                                      \
    "proxy.node.bandwidth_hit_ratio_int_pct", "proxy.node.cache.bytes_free", "proxy.node.cache.bytes_free_mb",                     \
    "proxy.node.cache.bytes_total", "proxy.node.cache.bytes_total_mb", "proxy.node.cache.bytes_used",                              \
    "proxy.node.cache.bytes_used_mb", "proxy.node.cache.percent_free", "proxy.node.cache.percent_free_int_pct",                    \
    "proxy.node.cache_hit_mem_ratio_avg_10s", "proxy.node.cache_hit_mem_ratio_avg_10s_int_pct",                                    \
    "proxy.node.cache_hit_mem_ratio_int_pct", "proxy.node.cache_hit_ratio_avg_10s", "proxy.node.cache_hit_ratio_avg_10s_int_pct",  \
    "proxy.node.cache_hit_ratio_int_pct", "proxy.node.cache_total_hits", "proxy.node.cache_total_hits_avg_10s",                    \
    "proxy.node.cache_total_hits_mem", "proxy.node.cache_total_hits_mem_avg_10s", "proxy.node.cache_total_misses",                 \
    "proxy.node.cache_total_misses_avg_10s", "proxy.node.client_throughput_out", "proxy.node.client_throughput_out_kbit",          \
    "proxy.node.cluster.nodes", "proxy.node.current_cache_connections", "proxy.node.current_client_connections",                   \
    "proxy.node.current_server_connections", "proxy.node.dns.lookup_avg_time_ms", "proxy.node.dns.lookups_per_second",             \
    "proxy.node.dns.total_dns_lookups", "proxy.node.hostdb.hit_ratio_avg_10s", "proxy.node.hostdb.hit_ratio_int_pct",              \
    "proxy.node.hostdb.total_hits", "proxy.node.hostdb.total_hits_avg_10s", "proxy.node.hostdb.total_lookups",                     \
    ...
    "proxy.node.http.origin_server_current_connections_count", "proxy.node.http.origin_server_total_request_bytes",                \
    "proxy.node.http.origin_server_total_response_bytes", "proxy.node.http.origin_server_total_transactions_count",                \
    "proxy.node.http.parent_proxy_total_request_bytes", "proxy.node.http.parent_proxy_total_response_bytes",                       \
    ...
    "proxy.node.http.user_agent_current_connections_count", "proxy.node.http.user_agent_total_request_bytes",                      \
    "proxy.node.http.user_agent_total_response_bytes", "proxy.node.http.user_agent_xacts_per_second",                              \
    "proxy.node.http.user_agents_total_documents_served", "proxy.node.http.user_agents_total_transactions_count",                  \
    "proxy.node.log.bytes_received_from_network_avg_10s", "proxy.node.log.bytes_sent_to_network_avg_10s",                          \
    "proxy.node.num_processes", "proxy.node.origin_server_total_bytes", "proxy.node.origin_server_total_bytes_avg_10s",            \
    "proxy.node.proxy_running", "proxy.node.restarts.manager.start_time", "proxy.node.restarts.proxy.cache_ready_time",            \
    "proxy.node.restarts.proxy.start_time", "proxy.node.restarts.proxy.stop_time", "proxy.node.user_agent_total_bytes",            \
    "proxy.node.user_agent_total_bytes_avg_10s", "proxy.node.user_agent_xacts_per_second",                                         \
    "proxy.node.user_agents_total_documents_served", "proxy.node.version.manager.build_time",                                      \
    "proxy.process.cache.KB_read_per_sec", "proxy.process.cache.KB_write_per_sec", "proxy.process.cache.bytes_total",              \
    "proxy.process.cache.bytes_used", "proxy.process.cache.direntries.total", "proxy.process.cache.direntries.used",               \
    "proxy.process.cache.evacuate.active", "proxy.process.cache.lookup.active", "proxy.process.cache.percent_full",                \
    "proxy.process.cache.ram_cache.bytes_total", "proxy.process.cache.ram_cache.bytes_used",                                       \
    "proxy.process.cache.ram_cache.total_bytes", "proxy.process.cache.read.active", "proxy.process.cache.read_per_sec",            \
    "proxy.process.cache.remove.active", "proxy.process.cache.scan.active", "proxy.process.cache.update.active",                   \
    "proxy.process.cache.write.active", "proxy.process.cache.write_per_sec", "proxy.process.cluster.cache_callback_time",          \
    "proxy.process.cluster.cache_outstanding", "proxy.process.cluster.cluster_ping_time",                                          \
    "proxy.process.cluster.connections_avg_time", "proxy.process.cluster.connections_open",                                        \
    "proxy.process.cluster.control_messages_avg_receive_time", "proxy.process.cluster.control_messages_avg_send_time",             \
    "proxy.process.cluster.lkrmt_cache_callback_time", "proxy.process.cluster.local_connection_time",                              \
    "proxy.process.cluster.open_delay_time", "proxy.process.cluster.rdmsg_assemble_time",                                          \
    "proxy.process.cluster.remote_connection_time", "proxy.process.cluster.remote_op_reply_timeouts",                              \
    "proxy.process.cluster.remote_op_timeouts", "proxy.process.cluster.rmt_cache_callback_time",                                   \
    "proxy.process.dns.fail_avg_time", "proxy.process.dns.in_flight", "proxy.process.dns.lookup_avg_time",                         \
    "proxy.process.dns.success_avg_time", "proxy.process.dns.total_dns_lookups", "proxy.process.hostdb.total_entries",             \
    "proxy.process.hostdb.total_hits", "proxy.process.hostdb.total_lookups",                                                       \
    ...
    "proxy.process.http.cache_connection_time", "proxy.process.http.client_connection_time",                                       \
    "proxy.process.http.client_transaction_time", "proxy.process.http.client_write_time",                                          \
    ...
    "proxy.process.http.icp_raw_transaction_time", "proxy.process.http.icp_transaction_time",                                      \
    ...
    "proxy.process.http.origin_server_response_header_total_size", "proxy.process.http.origin_server_speed_bytes_per_sec_100",     \
    "proxy.process.http.origin_server_speed_bytes_per_sec_100K", "proxy.process.http.origin_server_speed_bytes_per_sec_100M",      \
    "proxy.process.http.origin_server_speed_bytes_per_sec_10K", "proxy.process.http.origin_server_speed_bytes_per_sec_10M",        \
    "proxy.process.http.origin_server_speed_bytes_per_sec_1K", "proxy.process.http.origin_server_speed_bytes_per_sec_1M",          \
    "proxy.process.http.parent_proxy_connection_time", "proxy.process.http.parent_proxy_raw_transaction_time",                     \
    "proxy.process.http.parent_proxy_request_total_bytes", "proxy.process.http.parent_proxy_response_total_bytes",                 \
    "proxy.process.http.parent_proxy_transaction_time", "proxy.process.http.pushed_document_total_size",                           \
    "proxy.process.http.pushed_response_header_total_size", "proxy.process.http.server_connection_time",                           \
    "proxy.process.http.server_raw_transaction_time", "proxy.process.http.server_read_time",                                       \
    "proxy.process.http.server_transaction_time", "proxy.process.http.total_client_connections",                                   \
    "proxy.process.http.total_client_connections_ipv4", "proxy.process.http.total_client_connections_ipv6",                        \
    "proxy.process.http.total_incoming_connections", "proxy.process.http.total_parent_proxy_connections",                          \
    "proxy.process.http.total_server_connections", "proxy.process.http.total_transactions_think_time",                             \
    "proxy.process.http.total_transactions_time", "proxy.process.http.total_x_redirect_count",                                     \
    "proxy.process.http.transaction_totaltime.errors.aborts", "proxy.process.http.transaction_totaltime.errors.connect_failed",    \
    "proxy.process.http.transaction_totaltime.errors.early_hangups",                                                               \
    "proxy.process.http.transaction_totaltime.errors.empty_hangups", "proxy.process.http.transaction_totaltime.errors.other",      \
    "proxy.process.http.transaction_totaltime.errors.possible_aborts",                                                             \
    "proxy.process.http.transaction_totaltime.errors.pre_accept_hangups", "proxy.process.http.transaction_totaltime.hit_fresh",    \
    "proxy.process.http.transaction_totaltime.hit_fresh.process", "proxy.process.http.transaction_totaltime.hit_revalidated",      \
    "proxy.process.http.transaction_totaltime.miss_changed", "proxy.process.http.transaction_totaltime.miss_client_no_cache",      \
    "proxy.process.http.transaction_totaltime.miss_cold", "proxy.process.http.transaction_totaltime.miss_not_cacheable",           \
    "proxy.process.http.transaction_totaltime.other.unclassified", "proxy.process.http.user_agent_request_document_total_size",    \
    "proxy.process.http.user_agent_request_header_total_size", "proxy.process.http.user_agent_response_document_total_size",       \
    "proxy.process.http.user_agent_response_header_total_size", "proxy.process.http.user_agent_speed_bytes_per_sec_100",           \
    ...
    "proxy.process.https.total_client_connections", "proxy.process.log.log_files_open", "proxy.process.log.log_files_space_used",  \
    "proxy.process.net.accepts_currently_open", "proxy.process.net.connections_currently_open",                                    \
    "proxy.process.socks.connections_currently_open", "proxy.process.ssl.total_handshake_time",                                    \
    "proxy.process.ssl.total_success_handshake_count", "proxy.process.ssl.user_agent_session_timeout",                             \
