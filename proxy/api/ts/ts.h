...
typedef enum { TS_STAT_PERSISTENT = 1, TS_STAT_NON_PERSISTENT } TSStatPersistence;

typedef enum { TS_STAT_SYNC_SUM = 0, TS_STAT_SYNC_COUNT, TS_STAT_SYNC_AVG, TS_STAT_SYNC_TIMEAVG } TSStatSync;
