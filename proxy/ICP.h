...
typedef enum { PEER_NONE = 0, PEER_PARENT = 1, PEER_SIBLING = 2, PEER_LOCAL = 3, PEER_MULTICAST = 4 } PeerType_t;
...
private:
  enum { STATIC_BITMAP_BYTE_SIZE = 16, BITS_PER_BYTE = 8 };
...
public:
  ...
  typedef enum { RC_RECONFIG, RC_ENABLE_ICP, RC_DONE } ReconfigState_t;
